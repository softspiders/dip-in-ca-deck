...
```ts 5:9,14 file=../../src/dip/CounterInteractor.ts subtitle="С использованием принципа DIP"
```
...
```ts 1,3 file=../../src/dip/ConsoleLogger.ts subtitle="С использованием принципа DIP"
```
...
```ts 1,3[28:45] file=../../src/dip/ConsoleLogger.ts subtitle="С использованием принципа DIP"
```
