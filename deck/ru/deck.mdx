...
имён. Такие compile-time-зависимости в UML  могут помечаться стереотипом *import*.
...
Как ранее уже было отмечено, design-time-зависимости создают проблемы, которые необходимо решать устранением таких
зависимостей (по-английски это действие называется одним словом - *decoupling*).
