...
<Step title="Сравниваем использование: модули index.ts">

```ts file=../src/naive/index.ts subtitle="Наивная реализация"
```

```ts file=../src/better/index.ts subtitle="С использованием DIP"
```
...
```ts 2,4 file=../src/better/index.ts subtitle="С использованием DIP"
```
...
```ts file=../src/better/CounterInteractor.ts subtitle="С использованием DIP"
```
...
```ts 1,5 file=../src/naive/NaiveCounter.ts subtitle="Наивная реализация"
```

```ts 5:9,14 file=../src/better/CounterInteractor.ts subtitle="С использованием принципа DIP"
```
...
```ts file=../src/better/ConsoleLogger.ts subtitle="С использованием DIP"
```
...
```ts 1,3 file=../src/better/ConsoleLogger.ts subtitle="С использованием принципа DIP"
```
...
```ts 1,3[28:45] file=../src/better/ConsoleLogger.ts subtitle="С использованием принципа DIP"
```
