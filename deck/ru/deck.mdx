...
То, что он называет "традиционными методами разработки" мы только что видели в уже приведённом примере.
И там не было никакой инверсии.

Теперь покажем пример, в котором инверсия присутствует буквально.

</Notes>

---

## Поговорим о *требуемых интерфейсах*

<Notes>

Но вначале поговорим о *требуемых интерфейсах* (на английском - *required interface*).
...
Это по сути очень простые понятия, которые почему-то до сих пор они отсутствуют в языках программирования, что часто
создаёт ложное впечатление сложности.
