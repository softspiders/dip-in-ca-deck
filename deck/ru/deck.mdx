...
Пунктирная стрелка с надписью *Use* в UML означает зависимость. Как нетрудно догадаться, благодаря надписи *Use*, стрелка
направлена от зависимого модуля к модулю-зависимости.
